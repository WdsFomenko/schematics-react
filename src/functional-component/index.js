...
function functionalComponent(options) {
    ...
    const templateSource = schematics_1.apply(schematics_1.url('./files'), [
        ...
        schematics_1.template(Object.assign(Object.assign(Object.assign({}, core_1.strings), { 'if-flat': (s) => options.subfolder ? s : '', jsext: !!options.ts ? 'ts' : 'js', jsxext: !!options.ts ? 'tsx' : 'js' }), options)),
